...
# MANDATORY: Verify dynamic library linking with ldd and whisper-cli execution in STAGE 3 runner
RUN ldd /app/backend/models/whisper/whisper-cli && \
    /app/backend/models/whisper/whisper-cli --help > /dev/null && \
